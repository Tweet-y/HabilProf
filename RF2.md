...
1. **Recuperación de Datos**: Obtiene alumnos sin habilitación y profesores separados por DINF y UCSC
...
## Vista - habilitacion_create.blade.php

### Interacciones Dinámicas

- **Selección de Alumno**: Selector de alumnos disponibles (sin habilitación)
- **Secciones Condicionales**: Usa JavaScript para mostrar/ocultar campos según tipo
- **Envío de Formulario**: Directo con validación previa
- **Scroll Automático**: A mensajes de error/éxito del servidor

### Funciones JavaScript en la Vista

- **toggleSections()**: Muestra/oculta secciones y ajusta required dinámicamente
- **validarFormulario()**: Ejecuta validaciones antes de envío
...
- **GET /ingreso**: Muestra formulario de creación (create)
- **POST /ingreso**: Procesa creación (store)
