...
return [
    ...
    'custom' => [
        'email' => [
            'regex' => 'El correo debe tener el formato usuario@ucsc.cl (4-30 caracteres, solo letras minúsculas).',
            'min' => 'El correo debe tener al menos :min caracteres.',
            'max' => 'El correo no puede tener más de :max caracteres.',
